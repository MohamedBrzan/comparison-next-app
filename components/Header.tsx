...
export default function Header() {
  return (
    <header className="flex flex-row flex-wrap justify-around py-2  w-full border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30 mb-4">
      <div className="logo">
        <Link href="/">
